#!/usr/bin/env perl
# $Id: cluster_synteny.pl 32957 2010-08-05 16:22:09Z mbasu $

##---------------------------------------------------------------------------##
##  File: cluster_synteny.pl
##
##  Author:
...
cluster_synteny.pl - One line description.

=head1 SYNOPSIS

cluster_synteny.pl [options] -o <option>
