# $Id$
# Perl module for Pangenome::MethodFactory
...
Pangenome::MethodFactory  - DESCRIPTION of Object
...
package Pangenome::MethodFactory;
...
#	print STDERR "$real_method_name\n";
	my $module_name = "Pangenome::Method::".$real_method_name."::Run";
